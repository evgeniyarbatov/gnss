...
`constellations.json` lists five GNSS groups: `qzs`, `beidou`, `glonass`, `navstar`, `galileo`.
...
2. For each name, request `https://celestrak.org/NORAD/elements/gp.php?NAME={name}&FORMAT=json-pretty`.
